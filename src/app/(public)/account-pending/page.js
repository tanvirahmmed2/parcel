...
export default function AccountPendingPage() {
  return (
    <div className="flex-1 flex items-center justify-center p-4 text-center font-sans">
      <div className="bg-white p-12 rounded-3xl shadow-xl border border-amber-100 max-w-lg w-full flex flex-col items-center">
         ...
         <Link href="/api/auth/logout" className="bg-black text-white px-8 py-4 rounded-full font-bold hover:bg-slate-800 transition w-full shadow-md">
           Sign Out
         </Link>
      </div>
    </div>
