              ...
              users.map(u => (
               <tr key={u._id} className="hover:bg-slate-50 transition">
                 ...
                 <td className="p-4 text-right space-x-2">
                   ...
                   <button onClick={() => setStatus(u._id, 'SUSPENDED')} className="text-red-600 hover:bg-red-50 px-3 py-1.5 rounded-lg border border-red-200 font-medium transition"><XCircle className="w-4 h-4 inline mr-1"/>Suspend</button>
                 </td>
               </tr>
             ))}
           </tbody>
